...
<div class="main-content transition-all duration-300 pt-10 px-4 sm:px-8 min-h-screen flex justify-center items-start">
  <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-xl">
    <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center"> Chi Tiet Người Dùng</h2>
    ...
    <form action="#" >
      ...
      <div>
        ...
        <input type="text" id="ten" name="ten" maxlength="50" required placeholder="Nhập tên"
          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?=$user->ten ?>"readonly >
      </div>
      ...
      <div>
        ...
        <input type="email" id="email" name="email" maxlength="50" required placeholder="Nhập email"
          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?=$user->email ?>"readonly>
      </div>
      <!-- Địa chỉ (optional) -->
      <div>
        ...
        <input type="text" id="diachi" name="diachi" maxlength="255" placeholder="Nhập địa chỉ"
          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?=$user->diachi ?>"readonly>
      </div>
      ...
      <div>
        ...
        <input type="text" id="sdt" name="sdt" maxlength="10" pattern="\d{10}" required placeholder="Nhập số điện thoại 10 số"
          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?=$user->sdt ?>"readonly>
      </div>
      ...
      <div>
        ...
        <select id="role" name="role" required
          class="w-full border border-gray-300 rounded-lg px-4 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"> readonly 
          <option value="1"
          <?php
          if($user->role == "1"){
            echo "selected";
