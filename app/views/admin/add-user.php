...
<div class="main-content transition-all duration-300 pt-10 px-4 sm:px-8 min-h-screen flex justify-center items-start">
  <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-xl">
    <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center">Thêm mới Người dùng</h2>

    <form action="<?=BASE_URL?>?role=admin&act=post-add-user" method="POST" class="space-y-6" enctype="multipart/form-data">
      <!-- Name (required) -->
      <div>
