           ...
           " >
            ...
            <div id="Customers-flush" class="hidden overflow-hidden">
                <ul class="nav flex-col flex-wrap ps-0 ms-2">
                    ...
                    <?php if (isset($_GET['act']) && $_GET['act'] == 'all-user') echo 'active'; ?>
                    ">
                        <a href="<?= BASE_URL ?>?role=admin&act=all-user" class="nav-link hover:text-primary-500 px-3 py-3 flex items-center">
                            <i class="icofont-dotted-right me-2 text-slate-600"></i> All User
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= BASE_URL ?>?role=admin&act=add-user" class="nav-link hover:text-primary-500 px-3 py-3 flex items-center">
                            <i class="icofont-dotted-right me-2 text-slate-600"></i> Add User
                        </a>
                    </li>
                </ul>
            </div>
